       ...
       for _tmp in histograms:
           if (_tmp.th1 is not None):
              if hasattr(_tmp.th1, 'GetNbinsX'):
                 if _tmp.th1.Integral() <= 0.: continue
...
if __name__ == '__main__':
   ...
   for _hkey in th1Keys:
       for _keyw in KEYWORDS:
           ...
           _legXY = [
               Lef+(1-Rig-Lef)*_plotConfig.legXY[0],
               Bot+(1-Bot-Top)*_plotConfig.legXY[1],
               Lef+(1-Rig-Lef)*_plotConfig.legXY[2],
               Bot+(1-Bot-Top)*_plotConfig.legXY[3]
           ]

           logY_list = [(False, '')]
           if _plotConfig.logY:
               logY_list += [(True, '_logY')]

           ## plot(s)
           for logY, logY_postfix in logY_list:
               plot(**{
                 ...
                 'outputs': [f'{OUTDIR}/{_plotConfig.outputName}{logY_postfix}.{_tmp}' for _tmp in EXTS],
