...
if __name__ == '__main__':
   ...
   parser.add_argument('-t', '--tree-name', dest='tree_name', action='store', default='Events',
   ...
   parser.add_argument('-n', '--nperjob', dest='nperjob', type=int, action='store', default=5000,
